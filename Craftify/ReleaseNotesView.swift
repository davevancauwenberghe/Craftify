...
let releaseNotes: [ReleaseNote] = [
    ReleaseNote(version: "Version 1.0 - Build 113-119", changes: [
        "New: Chests replaced favorites",
    ...
    ReleaseNote(version: "Version 1.0 - Build 111-112", changes: [
        ...
        "Reworked the More and AboutView sections",
        "Reworked light mode",
        "Restored empty favorites view",
        "Backend code fixes to mitigate crashes on startup",
        "Image assets added",
        "Bug fixes"
    ]),
    ...
    ReleaseNote(version: "Version 1.0 - Build 100-102", changes: [
        "iOS 26/iPadOS 26 support added",
        "Image assets added",
        "New dyes textures added",
        "New app icon",
        "Minor UI fixes"
    ]),
    ReleaseNote(version: "Version 1.0 - Build 96-99", changes: [
        "User text size prefrences added",
        "Visual hint in RecipeDetailView added",
        "OnboardingView refinements",
        "Image assets added"
    ]),
    ReleaseNote(version: "Version 1.0 - Build 90-95", changes: [
